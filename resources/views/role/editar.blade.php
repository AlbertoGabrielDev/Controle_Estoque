            ...
            <table class="w-full border-collapse border border-gray-300">
                <thead>
                    <tr class="bg-gray-200">
                        ...
                        <th class="border border-gray-300 p-2">Create</th>
                        <th class="border border-gray-300 p-2">Edit</th>
                        <th class="border border-gray-300 p-2">Delete</th>
                        <th class="border border-gray-300 p-2">Export</th>
                        <th class="border border-gray-300 p-2">Import</th>
                        <th class="border border-gray-300 p-2">Mark Complete</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="border border-gray-300 p-2 text-center"><input type="checkbox" class="permission-checkbox" checked></td>
                        <td class="border border-gray-300 p-2 text-center"><input type="checkbox" class="permission-checkbox" checked></td>
                        <td class="border border-gray-300 p-2 text-center"><input type="checkbox" class="permission-checkbox" checked></td>
                        <td class="border border-gray-300 p-2 text-center"><input type="checkbox" class="permission-checkbox" checked></td>
                        <td class="border border-gray-300 p-2 text-center"><input type="checkbox" class="permission-checkbox"></td>
                        <td class="border border-gray-300 p-2 text-center"><input type="checkbox" class="permission-checkbox"></td>
                        <td class="border border-gray-300 p-2 text-center"><input type="checkbox" class="permission-checkbox"></td>
                    </tr>
                </tbody>
