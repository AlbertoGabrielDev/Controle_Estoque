...
<form action="{{route('categoria.inserirCategoria')}}" method="POST" enctype="multipart/form-data">
  ...
  <button class="block text-gray-500 py-2.5 px-4 relative mx-5 my-4 w-48 rounded transition duration-200 hover:bg-gradient-to-r hover:from-cyan-400 hover:to-cyan-300 hover:text-white"href="{{route('categoria.cadastro')}}">
