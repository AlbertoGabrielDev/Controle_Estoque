...
<div class="bg-white p-4 rounded-md w-full">
    ...
    <form action="{{route('produtos.salvarCadastro')}}" method="POST">
        ...
        <div class="grid md:grid-cols-2 md:gap-6 py-4">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <select class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" name="nome" >
                <option value="{{old('nome')}}">Selecione uma Categoria</option>
