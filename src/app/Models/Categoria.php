...
class Categoria extends Model
{
    ...
    {
        return $this->belongsTo(Categoria::class, 'categoria_pai_id', 'id_categoria');
    }

    public function filhas()
    {
        return $this->hasMany(Categoria::class, 'categoria_pai_id', 'id_categoria');
    }
    ...
    {
        static::saving(function (Categoria $model) {
