...
const stopSyncFilters = useQueryFilters(form, 'impostos.index')
...
<template>
  ...
  <div class="flex justify-between items-center mb-6">
    <h2 class="text-2xl font-semibold text-slate-700">Impostos</h2>
    <div class="flex gap-4">
      <Link :href="route('impostos.create')" class="flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-md text-gray-800 transition-colors">
  ...
  <DataTable
    table-id="dt-impostos"
    :ajax-url="route('impostos.data')"
    :ajax-params="form"
    :columns="dtColumns"
    :order="[[0, 'asc']]"
    :page-length="10"
