...
<body class="p-5 bg-gray-100">
    ...
    <form id="upload-form" enctype="multipart/form-data" class="flex flex-col space-y-3 w-full">
        @csrf
        ...
        <div class="flex space-x-5">
            ...
            <div class="w-1/2">
                ...
                <div class="overflow-auto h-80 border p-2">
                    <table id="table1" class="min-w-full border-collapse border border-gray-300">
            ...
            <div class="w-1/2">
                ...
                <div class="overflow-auto h-80 border p-2">
                    <table id="table2" class="min-w-full border-collapse border border-gray-300">
    ...
    <div id="comparacao-container" class="mt-5 bg-white p-5 shadow rounded hidden">
        ...
        <div class="flex flex-wrap gap-3 mb-2">
            ...
            <button id="comparar" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded transition duration-300">
                Comparar
            </button>
        </div>
        ...
        $("#upload-form").submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#input1-container, #input2-container").hide();
                    $("#comparacao-container").removeClass("hidden");
