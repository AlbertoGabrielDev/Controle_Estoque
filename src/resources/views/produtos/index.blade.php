...
@section('conteudo')
  <div class="bg-white p-4 rounded-md w-full">
    ...
    <table id="Table" class="dt-server w-full" data-url="{{ route('produtos.data') }}" data-order='[[1,"asc"]]'
      data-length="15" data-actions='{
    "edit":   {"href": "{{ url('/verdurao/produtos/editar/:id') }}"},
    "toggle": {"href": "{{ route('produto.status', ['modelName' => 'produto', 'id' => ':id']) }}", "method":"POST"}
    }' data-columns='[
